    ...
    return (
      <div className="initializing-view pt-20 pb-20 pr-12 pl-12">
        {!this.props.requestedFileRecording &&
          // <h2 className="text-white text-3xl font-bold">Initializing. Please wait.</h2>
          <h2 className="text-white text-3xl">Initializing. Please wait.</h2>
        }
        {this.props.requestedFileRecording &&
          // <h2 className="text-white text-3xl font-bold">Processing {this.props.fileName.split("/").pop()}</h2>
          <h2 className="text-white text-3xl">Processing {this.props.fileName.split("/").pop()}</h2>
        }
         {/*Closed progress bar*/}
